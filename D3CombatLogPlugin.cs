// This plugin makes a D3 combat log file
...
{
    public class D3CombatLogPlugin : BasePlugin, IInGameTopPainter, INewAreaHandler
    {
		...
		public void AllowScanMonsters(Object source, System.Timers.ElapsedEventArgs e)
			...
			if (!Logging) return;			// if not both monitoring and logging, exit
